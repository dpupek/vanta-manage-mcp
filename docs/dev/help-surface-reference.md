...
- `playbook_resource_owner_assignment` - Assign integration resource owners/descriptions with current-employee validation.
...
| `add_tag_category_product_context` | manage | POST | `/customer-trust/tag-categories/{tagCategoryId}/product-contexts` | yes | yes |
...
| `add_trust_center_faq_category` | manage | POST | `/trust-centers/{slugId}/faq-categories` | yes | yes |
| `add_trust_center_resource_category` | manage | POST | `/trust-centers/{slugId}/resource-categories` | yes | yes |
| `add_trust_center_viewer` | manage | POST | `/trust-centers/{slugId}/viewers` | yes | yes |
| `approve_questionnaire` | manage | POST | `/customer-trust/questionnaires/{questionnaireId}/approve` | yes | yes |
...
| `audit_list_vendors` | audit | GET | `/audits/{auditId}/managed-vendors` | no | yes |
| `audit_list_vulnerabilities` | audit | GET | `/audits/{auditId}/vulnerabilities` | no | yes |
| `bulk_add_tags_to_controls` | manage | POST | `/trust-centers/{slugId}/controls/tags` | yes | yes |
| `bulk_remove_tags_from_controls` | manage | DELETE | `/trust-centers/{slugId}/controls/tags` | yes | yes |
...
| `connector_upload_file_for_document` | connectors | POST | `/v1/documents/{documentId}/uploads` | yes | yes |
| `create_answer_library_entry` | manage | POST | `/knowledge-base/answer-library` | yes | yes |
...
| `create_comment_for_control` | audit | POST | `/audits/{auditId}/controls/{controlId}/comments` | yes | yes |
| `create_comment_for_information_request` | audit | POST | `/audits/{auditId}/information-requests/{requestId}/comments` | yes | yes |
| `create_compliance_framework` | manage | POST | `/trust-centers/{slugId}/compliance-frameworks` | yes | yes |
...
| `create_deletion_request` | manage | POST | `/customer-trust/deletion-requests` | yes | yes |
| `create_document` | manage | POST | `/documents` | yes | yes |
| `create_document_resource` | manage | POST | `/knowledge-base/resources/documents` | yes | yes |
| `create_file_questionnaire` | manage | POST | `/customer-trust/questionnaires/file` | yes | yes |
| `create_group` | manage | POST | `/groups` | yes | yes |
...
| `create_webpage_resource` | manage | POST | `/knowledge-base/resources/webpages` | yes | yes |
...
| `delete_answer_library_entry_route` | manage | DELETE | `/knowledge-base/answer-library/{id}` | yes | yes |
| `delete_by_id` | manage | DELETE | `/vendors/{vendorId}` | yes | yes |
| `delete_comment_for_control` | audit | DELETE | `/audits/{auditId}/controls/{controlId}/comments/{commentId}` | yes | yes |
...
| `delete_compliance_framework` | manage | DELETE | `/trust-centers/{slugId}/compliance-frameworks/{frameworkId}` | yes | yes |
| `delete_contract` | manage | DELETE | `/contracts/{contractId}` | yes | yes |
| `delete_control` | manage | DELETE | `/controls/{controlId}` | yes | yes |
| `delete_customer_trust_account` | manage | DELETE | `/customer-trust/accounts/{accountId}` | yes | yes |
...
| `delete_knowledge_base_resource` | manage | DELETE | `/knowledge-base/resources/{id}` | yes | yes |
...
| `delete_risk_scenario_control` | manage | DELETE | `/risk-scenarios/{riskScenarioId}/controls/{controlId}` | yes | yes |
...
| `delete_trust_center_faq_category` | manage | DELETE | `/trust-centers/{slugId}/faq-categories/{categoryId}` | yes | yes |
| `delete_trust_center_resource` | manage | DELETE | `/trust-centers/{slugId}/resources/{resourceId}` | yes | yes |
| `delete_trust_center_resource_category` | manage | DELETE | `/trust-centers/{slugId}/resource-categories/{categoryId}` | yes | yes |
...
| `duplicate_audit` | audit | POST | `/audits/duplicate` | yes | yes |
| `flag_information_request_evidence` | audit | POST | `/audits/{auditId}/information-requests/{requestId}/flag-evidence` | yes | yes |
| `get_answer_library_entry` | manage | GET | `/knowledge-base/answer-library/{id}` | no | yes |
| `get_assessment_by_id` | manage | GET | `/vendors/{vendorId}/assessments/{assessmentId}` | no | yes |
| `get_assessments_by_vendor_id` | manage | GET | `/vendors/{vendorId}/assessments` | no | yes |
| `get_audit` | audit | GET | `/audits/{auditId}` | no | yes |
| `get_audit_evidence` | audit | GET | `/audits/{auditId}/evidence/{auditEvidenceId}` | no | yes |
| `get_audit_evidence_comment` | audit | GET | `/audits/{auditId}/evidence/{auditEvidenceId}/comments/{commentId}` | no | yes |
| `get_chatbot_conversation_messages` | manage | GET | `/trust-centers/{slugId}/chatbot/conversations/{conversationId}` | no | yes |
| `get_comment_for_information_request` | audit | GET | `/audits/{auditId}/information-requests/{requestId}/comments/{commentId}` | no | yes |
| `get_connected_integration` | manage | GET | `/integrations/{integrationId}` | no | yes |
| `get_contract` | manage | GET | `/contracts/{contractId}` | no | yes |
...
| `get_information_request` | audit | GET | `/audits/{auditId}/information-requests/{requestId}` | no | yes |
| `get_information_request_evidence` | audit | GET | `/audits/{auditId}/information-requests/{requestId}/evidence/{evidenceId}` | no | yes |
| `get_information_request_test_snapshot_evidence_detail` | audit | GET | `/audits/{auditId}/information-requests/{requestId}/evidence/{evidenceId}/test-snapshot` | no | yes |
| `get_issue` | manage | GET | `/issues/{issueId}` | no | yes |
| `get_knowledge_base_resource` | manage | GET | `/knowledge-base/resources/{id}` | no | yes |
| `get_monitored_computer` | manage | GET | `/monitored-computers/{computerId}` | no | yes |
| `get_organization_information` | audit | GET | `/audits/{auditId}/organization/information` | no | yes |
| `get_organization_notifications` | audit | GET | `/audits/{auditId}/organization/notifications` | no | yes |
...
| `get_questionnaire_response` | manage | GET | `/customer-trust/questionnaires/{questionnaireId}/responses/{responseId}` | no | yes |
...
| `get_tags_for_category` | manage | GET | `/customer-trust/tag-categories/{tagCategoryId}` | no | yes |
...
| `get_user` | manage | GET | `/users/{userId}` | no | yes |
| `get_vendor` | manage | GET | `/vendors/{vendorId}` | no | yes |
| `get_vendor_assessment_type_by_id` | manage | GET | `/vendor-assessment-types/{assessmentTypeId}` | no | yes |
...
| `import_idp_groups` | manage | POST | `/groups/import-from-idp` | yes | yes |
| `initiate_export` | manage | POST | `/customer-trust/questionnaires/exports` | yes | yes |
| `link_controls_to_risk_scenario` | manage | POST | `/risk-scenarios/{riskScenarioId}/controls` | yes | yes |
| `list_account_access_services` | audit | GET | `/audits/{auditId}/personnel/account-access/services` | no | yes |
| `list_answer_library_entries` | manage | GET | `/knowledge-base/answer-library` | no | yes |
| `list_assignable_users` | manage | GET | `/customer-trust/questionnaires/assignable-users` | no | yes |
...
| `list_audit_issues` | audit | GET | `/audits/{auditId}/issues/items` | no | yes |
| `list_audit_risks` | audit | GET | `/audits/{auditId}/risks/{snapshotId}` | no | yes |
| `list_audit_snapshots` | audit | GET | `/audits/{auditId}/issues/snapshots` | no | yes |
| `list_audits` | audit | GET | `/audits` | no | yes |
| `list_chatbot_conversations` | manage | GET | `/trust-centers/{slugId}/chatbot/conversations` | no | yes |
| `list_code_changes` | audit | GET | `/audits/{auditId}/assets/code-changes` | no | yes |
| `list_comments_for_control` | audit | GET | `/audits/{auditId}/controls/{controlId}/comments` | no | yes |
| `list_comments_for_information_request` | audit | GET | `/audits/{auditId}/information-requests/{requestId}/comments` | no | yes |
| `list_compliance_frameworks` | manage | GET | `/trust-centers/{slugId}/compliance-frameworks` | no | yes |
| `list_connected_integrations` | manage | GET | `/integrations` | no | yes |
| `list_contracts` | manage | GET | `/contracts` | no | yes |
...
| `list_deactivated_controls` | manage | GET | `/controls/deactivated-controls` | no | yes |
...
| `list_event_logs` | manage | GET | `/event-logs` | no | yes |
| `list_files_for_document` | manage | GET | `/documents/{documentId}/uploads` | no | yes |
| `list_frameworks` | manage | GET | `/frameworks` | no | yes |
| `list_importable_idp_groups` | manage | GET | `/groups/importable-idp-groups` | no | yes |
...
| `list_information_requests_for_control` | audit | GET | `/audits/{auditId}/controls/{controlId}/information-requests` | no | yes |
| `list_integrations` | audit | GET | `/audits/{auditId}/integrations` | no | yes |
| `list_issues` | manage | GET | `/issues` | no | yes |
| `list_knowledge_base_resources` | manage | GET | `/knowledge-base/resources` | no | yes |
...
| `list_personnel_account_access` | audit | GET | `/audits/{auditId}/personnel/account-access/{serviceId}` | no | yes |
| `list_personnel_groups` | audit | GET | `/audits/{auditId}/personnel/groups` | no | yes |
| `list_personnel_people` | audit | GET | `/audits/{auditId}/personnel/people` | no | yes |
| `list_policies` | manage | GET | `/policies` | no | yes |
| `list_questionnaire_responses` | manage | GET | `/customer-trust/questionnaires/{questionnaireId}/responses` | no | yes |
...
| `list_risk_scenario_controls` | manage | GET | `/risk-scenarios/{riskScenarioId}/controls` | no | yes |
| `list_risk_snapshots` | audit | GET | `/audits/{auditId}/risks/snapshots` | no | yes |
| `list_tag_categories` | manage | GET | `/customer-trust/tag-categories` | no | yes |
...
| `list_trust_center_data_collected` | manage | GET | `/trust-centers/{slugId}/data-collected` | no | yes |
| `list_trust_center_faq_categories` | manage | GET | `/trust-centers/{slugId}/faq-categories` | no | yes |
...
| `list_trust_center_resource_categories` | manage | GET | `/trust-centers/{slugId}/resource-categories` | no | yes |
...
| `list_users` | manage | GET | `/users` | no | yes |
| `list_vendor_assessment_types` | manage | GET | `/vendor-assessment-types` | no | yes |
...
| `remove_tag_category_product_context` | manage | DELETE | `/customer-trust/tag-categories/{tagCategoryId}/product-contexts/{productContextId}` | yes | yes |
| `remove_trust_center_viewer` | manage | DELETE | `/trust-centers/{slugId}/viewers/{viewerId}` | yes | yes |
| `replace_document_resource_file` | manage | POST | `/knowledge-base/resources/documents/{id}/upload` | yes | yes |
...
| `send_trust_center_viewer_invite_reminder` | manage | POST | `/trust-centers/{slugId}/viewers/{viewerId}/send-invite-reminder` | yes | yes |
...
| `update_answer_library_entry_route` | manage | PATCH | `/knowledge-base/answer-library/{id}` | yes | yes |
| `update_audit_evidence` | audit | PATCH | `/audits/{auditId}/evidence/{auditEvidenceId}` | yes | yes |
| `update_comment_for_control` | audit | PATCH | `/audits/{auditId}/controls/{controlId}/comments/{commentId}` | yes | yes |
...
| `update_compliance_framework` | manage | PATCH | `/trust-centers/{slugId}/compliance-frameworks/{frameworkId}` | yes | yes |
| `update_control_metadata` | manage | PATCH | `/controls/{controlId}` | yes | yes |
| `update_customer_trust_account` | manage | PATCH | `/customer-trust/accounts/{accountId}` | yes | yes |
| `update_document_resource` | manage | PATCH | `/knowledge-base/resources/documents/{id}` | yes | yes |
| `update_group` | manage | PATCH | `/groups/{groupId}` | yes | yes |
...
| `update_questionnaire_response_content` | manage | PATCH | `/customer-trust/questionnaires/{questionnaireId}/responses/{responseId}` | yes | yes |
| `update_questionnaire_response_owner` | manage | PATCH | `/customer-trust/questionnaires/{questionnaireId}/responses/{responseId}/owner` | yes | yes |
...
| `update_risk_scenario_control` | manage | PATCH | `/risk-scenarios/{riskScenarioId}/controls/{controlId}` | yes | yes |
...
| `update_trust_center_controls_in_category` | manage | PATCH | `/trust-centers/{slugId}/control-categories/{categoryId}/controls` | yes | yes |
| `update_trust_center_faq` | manage | PATCH | `/trust-centers/{slugId}/faqs/{faqId}` | yes | yes |
| `update_trust_center_faq_category` | manage | PATCH | `/trust-centers/{slugId}/faq-categories/{categoryId}` | yes | yes |
| `update_trust_center_resource` | manage | PATCH | `/trust-centers/{slugId}/resources/{resourceId}` | yes | yes |
| `update_trust_center_resource_category` | manage | PATCH | `/trust-centers/{slugId}/resource-categories/{categoryId}` | yes | yes |
...
| `update_trust_center_viewer` | manage | PATCH | `/trust-centers/{slugId}/viewers/{viewerId}` | yes | yes |
...
| `update_webpage_resource` | manage | PATCH | `/knowledge-base/resources/webpages/{id}` | yes | yes |
| `upload_compliance_framework_badge` | manage | POST | `/trust-centers/{slugId}/compliance-frameworks/{frameworkId}/badge` | yes | yes |
| `upload_contract` | manage | POST | `/contracts` | yes | yes |
...
| `upload_trust_center_favicon` | manage | POST | `/trust-centers/{slugId}/favicon` | yes | yes |
| `upsert_assessment_for_control` | audit | PUT | `/audits/{auditId}/controls/{controlId}/assessment` | yes | yes |
| `upsert_groups_for_trust_center_subscriber` | manage | PUT | `/trust-centers/{slugId}/subscribers/{subscriberId}/groups` | yes | yes |
| `upsert_trust_center_control_categories_order` | manage | PUT | `/trust-centers/{slugId}/control-categories/order` | yes | yes |
| `upsert_trust_center_controls_in_category_order` | manage | PUT | `/trust-centers/{slugId}/control-categories/{categoryId}/controls/order` | yes | yes |
| `upsert_trust_center_data_collected` | manage | PUT | `/trust-centers/{slugId}/data-collected` | yes | yes |
| `upsert_trust_center_resource_categories_order` | manage | PUT | `/trust-centers/{slugId}/resource-categories/order` | yes | yes |
| `upsert_trust_center_videos` | manage | PUT | `/trust-centers/{slugId}/videos` | yes | yes |
| `verify_answer_library_entry_route` | manage | POST | `/knowledge-base/answer-library/{id}/verify` | yes | yes |
| `verify_knowledge_base_resource` | manage | POST | `/knowledge-base/resources/{id}/verify` | yes | yes |
